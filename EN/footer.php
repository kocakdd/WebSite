                ...
                <div class="row one">
                    ...
                    <div class="col  item third">
                        ...
                        <ul>
                            ...
                            <li><a href="https://www.linkedin.com/company/quickfacts2/about/"><img src="../images/facebook.png" class="logo"/> <p class="text">Facebook</p></a></li>
                        </ul>
                    </div>
                </div>
                <div class="row line"></div>
                <div class="row end">
                    <div class="col Terms"><p> Terms and Conditions </p></div>
                    <div class="col copyright"><p>Ⓒ Quickfacts - Hypotheekvitaal 2020-2022</p></div>
                </div>
            </div>
        </footer>
    </div>
